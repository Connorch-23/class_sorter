...
public class CamperLibrary {
    ...
    private static List<List<String>> preferences;
    ...
    public static List<List<String>> getPreferences() {
        if (preferences == null) {
            createPreferences();
        }
        return preferences;
    ...
    /*private static void createCampers() {
        Camper charlie = new CamperImpl("Charlie","Johnson", "EX", "4L", 12, true, preferences.get((int) (Math.random() * 8)));
